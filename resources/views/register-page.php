  ...
  <!-- Connection card -->
    ...
    <form action="" class="container mt-5" style="width:50%; margin-bottom:4%; padding:0%; ">
        ...
        <div class=" form-group ">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Your firstname" required> <br>
        </div><br>
        <div class=" form-group ">
        ...
        <div class="form-group ">
                  <input type="text" name="name" class="form-control" id="name" placeholder="Confirm your password" required> <br>
        </div><br>
        </div>
         <button class="btn mt-1 w-25 " style="background-color:#00b371; color:white;">S'inscrire</button> <br><br>
         Vous avez déjà un compte ? <a href="" style="color:#00b371; font-style: none;">Connectez-vous !</a>

        ...
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          ...
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Nos marques</span> <i class="bi bi-chevron-down"></i></a>
                <ul>
              ...
              <li class="dropdown"><a href="#"><span></span><i class="bx bx-body"></i></a>
                <ul>
                      <li><a href="#bmw">Profile</a></li>
                      <li><a href="#toyota">Vos réservations</a></li>
                      <li><a href="#toyota">Se deconnecter</a></li>
                </ul>
              </li>
